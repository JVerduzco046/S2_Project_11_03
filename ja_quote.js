...
*/
// generates a number then associates it to a quote 
function randomInt(lowest, size) {
    return Math.floor(Math.random() * 10);
}
var randomQ = randomInt();
/////////////////////// This line DOESNT WORK ///////////////////////
// var quoteElem = document.getElementsByTagName("quotes").innerHTML;
// quoteElem = getQuote(randomQ);




// Makes a random quote apear on the screen every time we refresh it 
